...
int Win32Socket::Connect(const SocketAddress& addr) {
  ...
  /*
  1>e:\edu100dev\100mediasdk\branches\mediasdk_optimize\livesdk\signal\base\win32socketserver.cc(337):
  error C4996: 'WSAAsyncGetHostByName': Use GetAddrInfoExW() instead or define _WINSOCK_DEPRECATED_NO_WARNINGS to disable deprecated API warnings
  */
...
int Win32Socket::Close() {
  ...
  if (dns_) {
	  /*1>e:\edu100dev\100mediasdk\branches\mediasdk_optimize\livesdk\signal\base\win32socketserver.cc(510): error C4996: 'WSACancelAsyncRequest': Define _WINSOCK_DEPRECATED_NO_WARNINGS to disable deprecated API warnings
*/
